...
const About = () => {
  return (
    <section
      id="about"
      className="flex flex-col lg:flex-row items-center gap-[50px] px-[40px] lg:w-[90%] xl:w-[80%] 2xl:w-[70%] mx-auto"
    >
      <div className="space-y-4 lg:w-[50%] ml-auto text-[#8892b0]">
        ...
        <p>
          ...
          abilities. I obtained a software development diploma in addition to my{" "}
