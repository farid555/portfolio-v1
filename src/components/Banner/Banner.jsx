const Banner = () => {
  return (
    <div className="h-[100vh] px-[40px] flex flex-col items-start justify-center lg:w-[90%] xl:w-[80%] 2xl:w-[70%] mx-auto">
      ...
      <h1 className="text-[3rem] md:text-[4rem] text-[#ccd6f6] font-[700] leading-none mt-4 mb-5 md:mt-5 md:mb-6">
        Mohammad Farid Uzzaman
      </h1>
      <h1 className="text-[3rem] md:text-[2rem] text-[#8892b0] font-[700] leading-none">
      With more than two years of experience in cloud infrastructure, DevOps, and GitOps, I am an enthusiastic engineer seeking an internship to kickstart my career.
      </h1>
      ...
      <a
        className="button"
        href="https://drive.google.com/file/d/1RYr-o4cU_UEL4nw73OcH2MGv2FwIyNtt/view"
        target="blank"
      >
        See Resume
      </a>
